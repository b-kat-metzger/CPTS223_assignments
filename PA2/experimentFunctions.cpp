...
void stage1(AVLTree<int>* avl, int numIntegers) {
    ...
    cout << "         testHeight? " << testHeight(avl) << endl;
    
    double averageDepth = avl->averageDepth();
    cout << "(EXP2.5) The average depth: " << averageDepth << " (v.s. log2(n)=" << __log2__(numIntegers) << ")" << endl;
...
void stage2(AVLTree<int>* avl, int numRandomInsertRemove) {
    ...
    cout << "(EXP2.10) New average depth: " << newAverageDepth << " (v.s. log2(n)=" << __log2__(numIntegers) << ")" << endl;
