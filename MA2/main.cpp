...
Your answer: The average height is about O(nlog(n)/n)=O(log(n))

This was tested from the in-class lecture on trees where 500 random nodes were inserted/removed from a BST.
The average node height was 9.98 which is very close to log_2(500)=8.97. So the average height is about O(log(n))
*/
